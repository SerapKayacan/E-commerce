    ...
    <div class="row" id="main">
        ...
        <form action="{{ url('update_user/'.$user->id) }}" method="POST">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="mail" class="form-control" id="inputPassword3" placeholder="Email" name="email" value=" {{ $user->email }}">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="inputEmail3" placeholder="Password" name="password"value="">
